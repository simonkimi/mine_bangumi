...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "ParseSourceResponse.files":
		...
		return e.complexity.ParseSourceResponse.Files(childComplexity), true

	case "ParseSourceResponse.season":
		if e.complexity.ParseSourceResponse.Season == nil {
			break
		}

		return e.complexity.ParseSourceResponse.Season(childComplexity), true

	case "ParseSourceResponse.title":
		if e.complexity.ParseSourceResponse.Title == nil {
			break
		}
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		ec.unmarshalInputParseSourceInput,
	)
	first := true
...
var sources = []*ast.Source{
	{Name: "../api/source.graphql", Input: `input ParseSourceInput {
    source: String!
    parser: String!
}
...
func (ec *executionContext) fieldContext_ParseSourceResponse_title(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "ParseSourceResponse",
		Field:      field,
		IsMethod:   false,
		IsResolver: false,
...
func (ec *executionContext) _ParseSourceResponse_files(ctx context.Context, field graphql.CollectedField, obj *grmodel.ParseSourceResponse) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_ParseSourceResponse_files(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_ParseSourceResponse_files(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "ParseSourceResponse",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _ParseSourceResponse_season(ctx context.Context, field graphql.CollectedField, obj *grmodel.ParseSourceResponse) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_ParseSourceResponse_season(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_ParseSourceResponse_season(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "ParseSourceResponse",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) unmarshalInputParseSourceInput(ctx context.Context, obj interface{}) (grmodel.ParseSourceInput, error) {
	var it grmodel.ParseSourceInput
...
func (ec *executionContext) _ParseSourceResponse(ctx context.Context, sel ast.SelectionSet, obj *grmodel.ParseSourceResponse) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, parseSourceResponseImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("ParseSourceResponse")
		case "title":
			out.Values[i] = ec._ParseSourceResponse_title(ctx, field, obj)
		case "files":
			out.Values[i] = ec._ParseSourceResponse_files(ctx, field, obj)
		case "season":
			out.Values[i] = ec._ParseSourceResponse_season(ctx, field, obj)
		default:
...
func (ec *executionContext) unmarshalOParseSourceInput2ᚖgithubᚗcomᚋsimonkimiᚋminebangumiᚋinternalᚋappᚋgraphᚋgrmodelᚐParseSourceInput(ctx context.Context, v interface{}) (*grmodel.ParseSourceInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputParseSourceInput(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalOParseSourceResponse2ᚖgithubᚗcomᚋsimonkimiᚋminebangumiᚋinternalᚋappᚋgraphᚋgrmodelᚐParseSourceResponse(ctx context.Context, sel ast.SelectionSet, v *grmodel.ParseSourceResponse) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._ParseSourceResponse(ctx, sel, v)
}
